                ...
                <div class="row g-3 mb-4">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" class="form-control" name="dniProveedor" id="dniProveedor">
                    </div>
                    
                    <div class="form-group mb-3">
                      <label for="razonSocialProveedor" class="form-label">Razón Social</label>
                      <input type="text" class="form-control" name="razonSocialProveedor" id="razonSocialProveedor" required>
                    </div>
                    
                    <div class="form-group mb-3">
                      <label for="cuitProveedor" class="form-label">CUIT</label>
                      <input type="text" class="form-control" name="cuitProveedor" id="cuitProveedor" required>
                    </div>
                  </div>
